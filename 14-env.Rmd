...
```{r echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='(ref:EnvDef)'}
knitr::include_graphics("figures/env01_environment-structure.png")
```


> **parent environment &#8800; parent frame**: parent frame, called by `parent.frame()` The enclosing environment is distinguished from the parent frame: the latter (returned by `parent.frame()`) refers to the environment of the caller of a function (call stack).
...
```{r EnvFun, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap='(ref:EnvFun)', fig.show = 'hold'}
...
```{r EnvMap, echo = FALSE, out.width='100%', fig.align = 'center', fig.cap='(ref:EnvMap)', fig.show = 'hold'}
...
```{r EnvMap2, echo = FALSE, out.width='100%', fig.align = 'center', fig.cap='(ref:EnvMap2)', fig.show = 'hold'}
