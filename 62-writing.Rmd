...
Tables can be formatted in CSS if we are only interested in HTML output. Add the following internal `<style>` element or use an external CSS file.
...
.deftab th, .deftab td {
  vertical-align: top;
  text-align: left;
  padding-bottom: 15px;    /* space between two rows */
}
.deftab th {
...
<table class = "deftab">
  ...
  <tr>
    <td>Doe</td> <!-- use td tag if it should not be bold -->
    <td>John</td>
  </tr>
  <tr>
    <th>Doe</th>
